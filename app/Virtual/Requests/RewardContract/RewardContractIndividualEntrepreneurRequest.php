...
/**
 * @OA\Schema(
 *     title="Создание договора для ИП",
 *     type="object",
 *     required={"inn", "ogrnip", "company_name", "legal_address", "actual_address", "contact_face", "job_title", "phone", "email", "bik", "checking_account", "bank_name", "correspondent_account", "pick_up", "is_same_legal_address"},
 * )
 */
class RewardContractIndividualEntrepreneurRequest
{
    /**
     * @OA\Property(
     *     property="inn",
